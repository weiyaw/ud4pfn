...
# coverage (multivariate, n_est=16). Outputs land in outputs/2026-01-23/.
...
# gap (one-gap covariate design). Outputs land in outputs/2026-01-12/.
...
# real data analysis. Outputs land in outputs/2026-01-51/.
...
# entropic uncertainty decomposition (varying x^star). Outputs land in outputs/2026-01-61/.
...
# entropic uncertainty decomposition (varying number of data size). Outputs land in outputs/2026-01-62/.
for seed in $(seq 1000 1049); do
