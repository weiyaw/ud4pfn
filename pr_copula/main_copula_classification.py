...
def fit_copula_classification(y,x,n_perm = 10, seed = 20,n_perm_optim = None,single_x_bandwidth = True):
    ...
    fixed_opt_fun = mvcc.fun_ccll_perm_sp(hyperparam_opt,y_perm_opt,x_perm_opt)
    ...
    return copula_classification_obj(log_vn,logpmf_yn_perm,rho_opt,rho_opt_x,-fixed_opt_fun,y_perm,x_perm)
