...
Usage (from inside experiments/beta_bernoulli):

    # PFN version
    .venv/bin/python diagnostic.py \
        --mode pfn --checkpoint checkpoints/pfn.pt \
        --out checkpoints/diag.pt \
    ...
    .venv/bin/python diagnostic.py \
        ...
        --out checkpoints/diag_oracle_f64.pt \
